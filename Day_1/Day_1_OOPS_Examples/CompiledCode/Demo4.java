...
public class Demo4
{
	public static void main(String args[])
	{
		...
		m1=null;    /* what will happen to object where "m1" refers to ?
			the object to which "m1" was referring to will be marked for Garbage Collection 
			( provided no other reference referring to that object) and after some time 
			( depends on JVM implementation) it will be garbage collected.*/
