...
public class AccountDemo11
{
	public static void main(String args[])
	{
		...
		/* 		 suppose one more customer has opened an account but we do not have 
				 any details at present and at the same time we want to show that we have 3 customers.
		 */
