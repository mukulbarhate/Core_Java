...
/* DataInputStream lets an application read primitive Java data types from s
an underlying input stream in a machine-independent way. An application uses
 a data output stream to write data that can later be read by a data input stream.
*/
